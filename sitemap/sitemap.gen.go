...
// Valid indicates whether the value is a known member of the AccessRestriction enum.
func (e AccessRestriction) Valid() bool {
	switch e {
	case AccessRestrictionRegistration:
		return true
	case AccessRestrictionSubscription:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the URLChangefreq enum.
func (e URLChangefreq) Valid() bool {
	switch e {
	case URLChangefreqAlways:
		return true
	case URLChangefreqDaily:
		return true
	case URLChangefreqHourly:
		return true
	case URLChangefreqMonthly:
		return true
	case URLChangefreqNever:
		return true
	case URLChangefreqWeekly:
		return true
	case URLChangefreqYearly:
		return true
	default:
		return false
	}
