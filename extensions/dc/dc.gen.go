...
type DCCoverage = string

// DCCreator is an entity primarily responsible for making the resource.
type DCCreator = string

// DCDate represents a timestamp used in feed objects.
type DCDate = externalRef0.Timestamp
