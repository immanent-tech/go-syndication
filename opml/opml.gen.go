...
// BaseOutline defines model for BaseOutline.
type BaseOutline struct {
	...
	Category *string `json:"category,omitempty" xml:"category,omitempty,attr"`

	// Created is the date-time that the outline node was created.
	Created *string `json:"created,omitempty" xml:"created,omitempty,attr"`
	...
	IsBreakpoint *BreakpointState `json:"isBreakpoint,omitempty" xml:"isBreakpoint,omitempty,attr"`
	...
	IsComment *CommentState `json:"isComment,omitempty" xml:"isComment,omitempty,attr"`
...
type Head struct {
	...
	DateCreated *Date `json:"dateCreated,omitempty" validate:"omitempty,datetime" xml:"dateCreated,omitempty"`

	// DateModified is a date-time, indicating when the document was last modified.
	DateModified *Date `json:"dateModified,omitempty" validate:"omitempty,datetime" xml:"dateModified,omitempty"`
	...
	ExpansionState *string `json:"expansionState,omitempty" xml:"expansionState,omitempty"`
	...
	VertScrollState *string `json:"vertScrollState,omitempty" xml:"vertScrollState,omitempty"`

	// WindowBottom is a number, the pixel location of the bottom edge of the window.
	WindowBottom *string `json:"windowBottom,omitempty" xml:"windowBottom,omitempty"`

	// WindowLeft is a number, the pixel location of the left edge of the window.
	WindowLeft *string `json:"windowLeft,omitempty" xml:"windowLeft,omitempty"`

	// WindowRight is a number, the pixel location of the right edge of the window.
	WindowRight *string `json:"windowRight,omitempty" xml:"windowRight,omitempty"`

	// WindowTop is a number, the pixel location of the top edge of the window.
	WindowTop *string `json:"windowTop,omitempty" xml:"windowTop,omitempty"`
}
...
type OPML struct {
	...
	// Body represents the OPML <body> element.
	Body Body `json:"body" validate:"omitempty,dive,unique" xml:"body"`
...
type Outline struct {
	...
	HTMLURL *string `json:"htmlUrl,omitempty" validate:"url" xml:"htmlUrl,omitempty,attr"`
	...
	// Outlines is zero or more outline sub-elements.
	Outlines []Outline `json:"outline,omitempty" validate:"omitempty,dive,unique" xml:"outline,omitempty"`
	...
	Version *OutlineVersion `json:"version,omitempty" xml:"version,omitempty,attr"`
...
type RSSOutline struct {
	...
	// Version is the top-level description element from the feed.
	Version *RSSOutlineVersion `json:"version,omitempty" xml:"version,omitempty,attr"`
